...
class ImageTransferFacade {
  static final _predictionModelFile = 'models/prediction.tflite';
  static final _transformModelFile = 'models/transfer.tflite';

  static const int MODEL_TRANSFER_IMAGE_SIZE = 384;
  static const int MODEL_PREDICTION_IMAGE_SIZE = 256;

  static Interpreter? interpreterPrediction;
  static Interpreter? interpreterTransform;
  ...
  static Future<Uint8List?> transfer(Uint8List originData, Uint8List styleData) async {
    ...
    return img.encodeJpg(resultImage) as Uint8List;
  }

  static img.Image _convertArrayToImage(List<List<List<List<double>>>> imageArray, int inputSize) {
  ...
  static Uint8List _imageToByteListUInt8(
    img.Image image,
    int inputSize,
    double mean,
    double std,
